...
main() {
    ...
    run_restore "claude,wiki" "$HOME/.claude/wiki" || ((error_count++))
    run_restore "claude,skills" "$HOME/.claude/skills" || ((error_count++))
    run_restore "claude,plugins" "$HOME/.claude/plugins" || ((error_count++))
    run_restore "claude,managed-settings" "$HOME/.claude/managed-settings.d" || ((error_count++))
